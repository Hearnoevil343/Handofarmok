...
export const middleEarth: Recipe = {
  ...
  defaults: { rainfall: 50, drainage: 38, savagery: 30, alignment: 50, volcanism: 0 },
  ...
  regions: [
    ...
    { name: "Angmar", shape: oval(400, 245, 90, 45), set: { savagery: 85, alignment: 10, rainfall: 40 }, add: { temperature: -10 } },
    { name: "Withered Heath", shape: oval(706, 240, 60, 25), set: { savagery: 90, alignment: 30, rainfall: 20 } },

    // Eriador
    { name: "Lindon", shape: [[-20, 180], [160, 160], [190, 300], [170, 480], [120, 560], [-20, 560]], set: { rainfall: 72, savagery: 10, alignment: 75 }, add: { temperature: 12 } },
    { name: "Arnor heartland", shape: oval(290, 310, 90, 50), set: { rainfall: 50, savagery: 35 } },
    { name: "The Shire", shape: oval(232, 392, 40, 30), set: { rainfall: 55, savagery: 5, alignment: 72 } },
    { name: "Barrow-downs", shape: oval(281, 405, 14, 9), set: { drainage: 58, savagery: 50, alignment: 25 } },
    { name: "Lone-lands", shape: oval(360, 400, 55, 35), set: { rainfall: 40, savagery: 55 } },
    { name: "Trollshaws", shape: oval(434, 375, 30, 22), set: { savagery: 74, alignment: 35 } },
    { name: "Rivendell", shape: oval(471, 378, 10, 8), set: { savagery: 5, alignment: 92 }, feather: 4 },
    { name: "Ettenmoors", shape: oval(434, 311, 40, 28), set: { savagery: 80, alignment: 30, rainfall: 40, drainage: 55 } },
    ...
    { name: "Dunland", shape: oval(387, 478, 30, 40), set: { drainage: 58, savagery: 60, alignment: 40 } },

    // Rhovanion
    { name: "Mirkwood", shape: oval(655, 370, 90, 125), set: { savagery: 85, alignment: 40 } },
    { name: "Woodland Realm", shape: oval(694, 317, 40, 25), set: { savagery: 60, alignment: 72 } },
    { name: "Dol Guldur", shape: oval(601, 461, 30, 25), set: { savagery: 95, alignment: 5 } },
    { name: "Dale and Esgaroth", shape: oval(716, 315, 30, 22), set: { savagery: 20, alignment: 62 } },
    { name: "Lothlórien", shape: oval(519, 462, 20, 16), set: { savagery: 5, alignment: 96 }, feather: 5 },
    { name: "Fangorn", shape: oval(474, 525, 25, 20), set: { savagery: 86, alignment: 50 } },
    { name: "Brown Lands", shape: oval(625, 505, 45, 30), set: { rainfall: 3, drainage: 40, savagery: 70, alignment: 30 } },
    { name: "Emyn Muil", shape: oval(620, 554, 25, 15), set: { rainfall: 20, drainage: 60, savagery: 50 } },
    { name: "Dead Marshes", shape: oval(636, 572, 22, 11), set: { savagery: 62, alignment: 18 } },
    { name: "Dagorlad", shape: oval(668, 580, 35, 16), set: { rainfall: 5, drainage: 50, alignment: 20 } },
    { name: "Rhûn", shape: [[760, 380], [1050, 380], [1050, 640], [780, 580]], set: { rainfall: 26, savagery: 50, alignment: 35 } },
    { name: "Dorwinion", shape: oval(841, 450, 40, 25), set: { rainfall: 60, savagery: 20, alignment: 55 } },
    { name: "Khand", shape: oval(1000, 780, 120, 70), set: { rainfall: 14, savagery: 62, alignment: 30 } },

    // Rohan and Gondor
    { name: "Rohan", shape: oval(515, 585, 70, 40), set: { rainfall: 30, drainage: 38, savagery: 20, alignment: 60 } },
    { name: "Gondor", shape: [[400, 630], [640, 640], [640, 730], [560, 760], [420, 730]], set: { rainfall: 56, savagery: 18, alignment: 66 } },
    { name: "Anfalas", shape: oval(378, 705, 50, 25), set: { rainfall: 62, savagery: 25, alignment: 58 } },
    { name: "Ithilien", shape: oval(648, 672, 16, 62), set: { rainfall: 74, drainage: 40, savagery: 40, alignment: 56 }, feather: 6 },
    { name: "Harondor", shape: oval(600, 790, 70, 40), set: { rainfall: 12, drainage: 40, savagery: 45 } },

    // Mordor
    { name: "Lithlad", shape: oval(790, 640, 60, 20), set: { rainfall: 8, drainage: 45, savagery: 85, alignment: 5 } },
    { name: "Nurn", shape: oval(800, 725, 70, 25), set: { rainfall: 26, savagery: 80, alignment: 8 } },
    { name: "Gorgoroth", shape: oval(715, 650, 70, 38), set: { rainfall: 0, drainage: 30, savagery: 95, alignment: 0 }, add: { temperature: 12 }, feather: 10 },

    // the south
    { name: "Harad", shape: [[420, 830], [1050, 830], [1050, 1050], [420, 1050]], set: { rainfall: 4, drainage: 20, temperature: 98, savagery: 50, alignment: 40 }, feather: 40 },
    { name: "Umbar", shape: oval(538, 988, 40, 40), set: { rainfall: 26, drainage: 38, alignment: 30 } },
  ],
