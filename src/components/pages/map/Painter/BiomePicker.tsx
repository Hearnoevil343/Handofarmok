...
import { setActiveBiome } from "@store/slices/paintSlice";
...
export function BiomePicker() {
  ...
  const active = useSelector((s: RootState) => s.paint.activeBiome);
                ...
                <div className={styles.grid}>
                  {items.map((b: Biome) => (
                    <button
                      ...
                      onClick={() => { dispatch(setActiveBiome(b)); setOpen(false); }}
