...
export function GenerateWorld() {
  ...
  return (
    ...
    >
      ...
      <Selector value={archetype} options={opts(ARCHETYPE_NAMES)} onChange={setArchetype} />

      <span className={styles.field}>Climate</span>
      <Selector value={climate} options={opts(CLIMATE_NAMES)} onChange={setClimate} />
      ...
      <button
        ...
        onClick={() =>
          run(() =>
            write(generateWorld(worldManager.gridSize, archetype, climate, seed)),
          )
        }
      >
